        ...
        <>
            {view === 'List' ? (
                        ...
                        <Grid item xs={12} sm={7} md={6} lg={4}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item sm={9}>
                                    ...
                                    >
                                        ${user?.hourlyRate}{' '}
                                        <span className="timehoursList-title">/ hour</span>
                                    </div>
                                    <div className="commentRating-container">
                                        ...
                                        >
                                            ...
                                            / 5{' '}
                                            <span className="commentsRating-Listtitle">Rating</span>
                                        </div>
                                    </div>
                                </Grid>
                            </Grid>
                ...
                >
                    ...
                    <div
                        className={
                            dark ? 'grid-profile-name grid-profile-name-dark ' : 'grid-profile-name'
                        }
                    >
                        {profileName(user?.firstName, user?.lastName)}
                    </div>
                    ...
                    <div className="commentRating-container">
                        ...
                        >
                            {ratingCount(user?.comments, commentCount(user?.comments))} / 5{' '}
                ...
                >
                    <DialogTitle>
                        <div className="modalHeader-container">
                            <div
                                className={dark ? 'modalheading modalheading-dark' : 'modalheading'}
                            >
                                {' '}
                                Reviews
                            </div>
                    ...
                    >
                        <DialogContentText sx={{ mb: { xs: 8, md: 0 } }}>
                            ...
                            >
                                ...
                                <span className="timehoursList-title"> / 5</span>
                            </div>
                            <div className={dark ? 'Hr-grid Hr-grid-dark' : 'Hr-grid'}></div>
                            <div
                                className={
