...
const Index = ({ filterFor = 'home', dark }) => {
    ...
    return (
        <div className={dark ? 'banner-container banner-container-dark' : 'banner-container'}>
            <div className={dark ? 'banner-heading banner-heading-dark' : 'banner-heading'}>
                Welcome, {currentUser?.fullName} ✋{' '}
            </div>
            <div
                className={dark ? 'banner-Subheading banner-Subheading-dark' : 'banner-Subheading'}
            >
            ...
            <div
                className={
                    matches
                        ? 'banners-button-grid relative-position z-index-2'
                        : 'banners-button-grid-responsive relative-position z-index-2'
                }
            >
                {ButtonArr.map((item, i) => (
                    <div
                        ...
                        className={
                            dark
                                ? `${
                                      (condition ? activeTab : activeTabJOB) === item
                                          ? 'banner-Btn-active banner-Btn banner-Btn-dark'
                                          : 'banner-Btn banner-Btn-dark'
                                  }`
                                : `${
                                      (condition ? activeTab : activeTabJOB) === item
