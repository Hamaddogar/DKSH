...
const Index = ({ job, index, dark }) => {
    ...
    const { title, subTitle, description, skills, applications, rating, portfolio, hourlyRate } =
        job;
    return (
        <div className="job-container" key={index}>
            <div className="job-title-container">
                ...
                <div className={dark ? 'job-hourly-rate job-hourly-rate-dark' : 'job-hourly-rate'}>
                    ${hourlyRate}{' '}
                    <span className={dark ? 'job-hours white-text' : 'job-hours'}>/ hour</span>
                </div>
            </div>
            ...
            <div className="job-title-container">
                <div className="job-appli-container">
                    ...
                    <p className={dark ? 'job-appli white-text' : 'job-appli'}>
                        {applications}
                    </p>{' '}
                    Applications
                </div>
                <div className="job-appli-container">
                    <p className={dark ? 'job-appli white-text' : 'job-appli'}>{rating} / 5</p>{' '}
                    Rating
                </div>
            </div>
        </div>
