        ...
        <>
            <Box sx={{ ...styleSheet.flex, mt: 2, mb: 3 }}>
                <Box sx={{ ...styleSheet.flex }}>
                    ...
                    <span
                        className={
                            dark ? 'number_of_talents number_of_talents-dark' : 'number_of_talents'
                        }
                    >
                ...
                <Box sx={{ ...styleSheet.flex, flexDirection: { xs: 'column', sm: 'row' } }}>
                    ...
                    <Button
                        ...
                        title={
                            <img
                                alt=""
                                src={viewFilters || modelViewFilters ? FilterIcon : DarkFilterIcon}
                            />
                        }
            ...
            {viewFilters && !matches && (
                ...
                >
                        ...
                        <FilterButton
                            ...
                            component={
                                <Box
                                    className={
                                        dark
                                            ? 'scrollbox-dark dropdown-list'
                                            : 'scrollbox dropdown-list'
                                    }
                                    sx={{ gap: '10px' }}
                                >
                                    {(homeFilter
                                ...
                                <Box className="dropdown-list" sx={{ gap: '10px' }}>
                                    {list.map((option) => (
                                        <Box
                                            ...
                                            key={option}
                                            className={
                                                (homeFilter ? ratingFilter : ratingFilterJOB) ===
                                                option
                                                    ? 'dropdown-active-item white-text'
                                                    : 'dropdown-item'
                                            }
                    ...
                    {homeFilter && (
                        <Box
                            sx={{ ...styleSheet.flex, flexDirection: { xs: 'column', sm: 'row' } }}
                        >
                            <ToggleButton
...
const FilterButton = ({ icon, label, value, component, dark, onClick, ...rest }) => (
    <DropdownButton
        onClick={onClick}
        {...rest}
        dark={dark}
